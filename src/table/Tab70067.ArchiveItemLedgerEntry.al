table 70067 "Archive Item Ledger Entry"
{
    DrillDownPageID = 70102;
    LookupPageID = 70102;
    ...
    fields
    {
        ...
        {
            CaptionML = ENU='Entry Type OLD',
                        FRA='Type écriture OLD';
            OptionCaptionML = ENU='Purchase,Sale,Positive Adjmt.,Negative Adjmt.,Transfer',
                              FRA='Achat,Vente,Ajust. positif,Ajust. négatif,Transfert';
            OptionMembers = Purchase,Sale,"Positive Adjmt.","Negative Adjmt.",Transfer;
        }
        ...
        field(104;"Type Document";Text[100])
        {
            DataClassification = ToBeClassified;
        }
        field(105;"date insert";DateTime)
        {
            DataClassification = ToBeClassified;
        }
        field(106;"Centre de gestion";Code[20])
        {
            DataClassification = ToBeClassified;
        }
    }
