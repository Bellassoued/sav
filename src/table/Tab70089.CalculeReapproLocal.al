table 70089 "Calcule Reappro Local"
{
    DrillDownPageID = 70195;
    LookupPageID = 70195;
    ...
    fields
    {
        ...
        field(46;"date trasnt";DateTime)
        {
        }
        field(47;"Magasin en laison";Text[250])
        {
        }
        field(48;"Magasin en laison2";Text[250])
        {
        }
    }
    ...
    keys
    {
        key(Key1;"Ref Origine","Company Name","Location Code")
        {
        }
    }
