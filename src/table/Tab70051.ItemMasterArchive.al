table 70051 "Item Master Archive"
{
    // version PR00011

    CaptionML = ENU='Item Master',
                FRA='Master pièce Archive';
    DrillDownPageID = 70072;
    LookupPageID = 70072;
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Item Master Price Archive"."Item Price Category" WHERE (Item No.=FIELD(No.),
        ...
        {
            AutoFormatType = 2;
            CalcFormula = Lookup("Item Master Price Archive".Price WHERE (Item No.=FIELD(No.),
                                                                          Version=FIELD(Version)));
    ...
    keys
    {
        key(Key1;"Record ID","No.","Make Code")
        {
        }
    }
