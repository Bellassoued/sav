table 70068 "Item Pre Master"
{
    // version PR00011

    CaptionML = ENU='Item Master',
                FRA='Master pièce';
    DrillDownPageID = 70103;
    LookupPageID = 70103;
    ...
    fields
    {
        ...
        {
            CalcFormula = Lookup("Item Pre Master Price"."Catégorie de prix pièce" WHERE (Item No.=FIELD(No.)));
        ...
        {
            AutoFormatType = 2;
            CalcFormula = Lookup("Item Pre Master Price".Price WHERE (Item No.=FIELD(No.)));
            CaptionML = ENU='Price fob',
                        FRA='Prix fob';
            FieldClass = FlowField;
            MinValue = 0;
        }
        field(60;"Prix Fob Ancien Master";Decimal)
        {
            CalcFormula = Lookup("Item Master".Price WHERE (No.=FIELD(No.),
                                                            Make Code=FIELD(Make Code)));
            Description = 'SM 070617';
            FieldClass = FlowField;
        }
        field(61;"Exist Master";Boolean)
        {
            CalcFormula = Exist("Item Master" WHERE (No.=FIELD(No.)));
            Description = 'SM 070617';
            FieldClass = FlowField;
        }
        ...
        field(72;"DateInsertion Manuelle";DateTime)
        {
        }
        ...
        field(92;"Origin Code";Code[3])
        {
            ...
            begin
                ...
                IF LrecCountryRegion.FINDFIRST THEN
                  BEGIN
                    "Code Devise" := LrecCountryRegion.Devise;
                    "Code Pays"   := LrecCountryRegion.Code;
                  END;
            end;
        }
        ...
        field(133;"Sur Commande";Boolean)
        {
            CalcFormula = Lookup(Item."Sur commande" WHERE (No.=FIELD(No.)));
            FieldClass = FlowField;
        }
        field(50000;"Item Exist";Boolean)
        {
