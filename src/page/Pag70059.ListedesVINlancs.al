page 70059 "Liste des VIN lancés"
{
    DeleteAllowed = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    SourceTableView = WHERE(Statut PVN=CONST(Préparation lancée),
                    ...
                    BEGIN
                      ...
                      BEGIN
                          ...
                          BEGIN
                              ...
                              //ADD KK PVN
                              BordereauPVN.GET("No. Bord. PVN");
                              RecPreparationVN."Date livraison prévue" := BordereauPVN."Date Emission"+7;
                              //END KK
