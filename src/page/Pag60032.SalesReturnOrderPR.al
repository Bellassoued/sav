page 60032 "Sales Return Order PR"
{
            ...
            group("P&osting")
            {
                ...
                action("P&ost")
                {
                    ...
                    begin
                        ...
                        IF NOT UserSetup."Vente Inter Societe" THEN
                          ERROR(TXT50000);
                        //END KK
    ...
    var
        ...
        UserSetup : Record "91";
        TXT50000 : Label 'Vous ne disposer pas d''autorisation, veuillez contacter votre administrateur';
