    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("User under Activity";"User under Activity")
                {
                }
                ...
                field("Date Time Modification";"Date Time Modification")
                {
                }
                field("Chargé de Compte Initiateur";"Chargé de Compte Initiateur")
                {
                }
                field("créer par";"créer par")
                {
                }
                field("No. Cmd Web";"No. Cmd Web")
                {
                }
                ...
                field("Sales Folder No.";"Sales Folder No.")
                {
                }
