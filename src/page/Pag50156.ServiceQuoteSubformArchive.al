page 50156 "Service Quote Subform Archive"
{
    ...
    var
        ...
        CannotOpenWindowErr : TextConst ENU='You cannot open the window because %1 is %2 in the %3 table.',FRA='Vous ne pouvez pas ouvrir la fenêtre car %1 est à %2 dans la table %3.';

    local procedure RegisterServInvLines();
    var
        ServInvLine : Record "60088";
        ServInvLines : Page "50154";
    begin
