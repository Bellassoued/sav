page 60177 "Liste articles marketing"
{
    // version NAVW17.10.00.36703CU9RAD

    CaptionML = ENU='Item List',
                FRA='Liste des articles';
    CardPageID = "Articles Marketing";
    Editable = false;
    PageType = List;
    SourceTable = Table27;
    ...
    begin
        ...
        "Item type" := "Item type"::"Frais Generaux";
        Type := Type::Service ;
    end;
    ...
    begin
        ...
        FILTERGROUP(2);
        SETRANGE("Item type" ,"Item type"::"Frais Generaux");
        FILTERGROUP(0);
    end;
