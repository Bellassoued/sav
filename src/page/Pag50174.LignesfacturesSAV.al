page 50174 "Lignes factures SAV"
{
    Editable = false;
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field("Date Livraison PVN";"Date Livraison PVN")
                {
                }
                field("Date Livraison Client";"Date Livraison Client")
                {
                }
                field("PVN Livré Par";"PVN Livré Par")
                {
                }
                field("Client Livré Par";"Client Livré Par")
                {
                }
