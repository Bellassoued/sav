page 50144 "Fiche LC PR."
{
        ...
        area(content)
        {
            group("Général")
            {
                ...
                field("Taux d'ouverture";"Taux d'ouverture")
                {
                    ...
                    trigger OnValidate();
                    begin
                        "Montant LC DS" := ROUND("Taux d'ouverture" * "Montant LC",0.001);
                    end;
                }
                ...
                field("Montant LC DS";"Montant LC DS")
                {
                    Editable = false;
                }
                field(Banque;Banque)
    ...
    actions
    {
        area(processing)
        {
            ...
            action("Affectation dossier")
            {
                ...
                RunPageLink = No. LC PR=FIELD(Code L.C);
            }
            separator(Bordereau)
            {
                Caption = 'Bordereau';
    ...
    begin
        "Type Import L.C" := "Type Import L.C"::PR;
    end;
