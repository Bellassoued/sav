page 60327 "Tab. suivi Charge VIN"
{
    CaptionML = ENU='Tab. suivi Charge VIN',
                FRA='Tab. suivi Charge VIN';
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    begin
         ...
         IF NOT UserSetup."Charge VIN" THEN ERROR('interface non fonctionel');
    end;
